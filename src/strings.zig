...
pub fn compileTimeStringConcatExample() void {
    ...
    print("Compile-time concatenated string: {s}\n", .{compile_time_concat_string});
}
...
pub fn runtimeStringConcatExample() !void {
    ...
    const allocator_interface: *const std.mem.Allocator = &allocator_implementation.allocator();
    ...
    print("Runtime concatenated string: {s}\n", .{runtime_concat_string});
}
...
pub fn concatVariable(allocator: *const std.mem.Allocator, a: []const u8, b: []const u8) ![]u8 {
